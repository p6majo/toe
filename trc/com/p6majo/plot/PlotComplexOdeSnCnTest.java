...
public class PlotComplexOdeSnCnTest {
    ...
    public void setUp() throws Exception {
        ...
        //choose 0 for sn
        //choose 1 for cn
        cProvider = new ComplexOdeBSDataProvider(derivativeInf,imagDerivativeInf,ics,1);

        this.cPlot = new PlotComplex(cProvider);

        this.cPlot.addRange(-2.9,3,gridsize);//xrange
        this.cPlot.addRange(-2.9,3,gridsize);//yrange
