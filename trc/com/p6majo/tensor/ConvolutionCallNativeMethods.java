...
public class ConvolutionCallNativeMethods {
    @Test
    public void convolutionTest() {
        ...
        INDArray conv = convolution(preImage, filter);
        long end = System.currentTimeMillis();

        //large data sets
        //System.out.println("Final result after "+(end-start)+" ms:\n" +conv.getRow(0).getRow(0).getFloat(0,0));
        //small data sets
        System.out.println("Final result after "+(end-start)+" ms:\n" +conv);
    ...
    private INDArray convolutionNative(INDArray preImage,INDArray kernel){
        return null;
    }

    private INDArray convolution(INDArray preImage, INDArray filter){
