...
public class GuiForMNIST implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // create a GuiForMNIST with a menu, some buttons, and a drawing window of size width-by-height
    public GuiForMNIST(int width, int height) {
        ...
        JButton button1 = new JButton("Load Image Files");
    ...
    ***************************************************************************/
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if      (cmd.equals(" Save...   ")) StdOut.println("File -> Save");
        else if (cmd.equals("button 1"))    StdOut.println("Button 1 pressed");
        else if (cmd.equals("button 2"))    StdOut.println("Button 2 pressed");
        else if (cmd.equals("button 3"))    StdOut.println("Button 3 pressed");
        else if (cmd.equals("button 4"))    StdOut.println("Button 4 pressed");
        else                                StdOut.println("Unknown action");
    ...
    public void mousePressed(MouseEvent e) {
        int x = e.getX();
        int y = e.getY();
        StdOut.println("Mouse pressed at " + x + ", " + y);
    ...
    public void keyTyped(KeyEvent e) {
        StdOut.println("Key = '" + e.getKeyChar() + "'");
    }

    // test client
    public static void main(String[] args) {
        GuiForMNIST guiForMNIST = new GuiForMNIST(2300, 871);
        guiForMNIST.picture(0, 0, "/home/jmartin/workbase/toe/trc/com/p6majo/mnist/map.png");
        guiForMNIST.show();
    }
