...
public class ComplexPlotTestDn {
    ...
    public void generatePlot() {
        for (int r=101;r<199;r++) {
            ...
            ComplexFunction dn = new ComplexElliptDn(k,l);
            Box range = new Box(-8., -8, 8., 8.);
            //range.rescale(5.);
            int width = 200;
            int height = 200;
            ComplexPlot plot = new ComplexPlot(dn, range, ComplexPlot.PlotType.ARGMOD, width, height);
