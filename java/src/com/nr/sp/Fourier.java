...
public class Fourier {
  ...
  /**
   * For an integral approximated by a discrete Fourier transform, 
   * this routine computes the correction factor that multiplies
   * the DFT and the endpoint correction to be added. Input is the
   * angular frequency w, stepsize delta, lower and upper limits of 
   * the integral a and b, while the array endpts contains the first 4
   * and last 4 function values. The correction factor W .Â/ is returned
   * as corfac, while the real and imaginary parts of the endpoint correction
