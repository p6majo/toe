...
public class SoftMaxLayer extends Layer {
    ...
    public SoftMaxLayer(int[] signature) {
        //the layer doen't change the data structure
        super(signature, signature);
        super.name = "SoftMax Layer";
    }
    ...
    public void pushForward(Batch batch) {
        ...
        super.activations = Nd4j.getExecutioner().execAndReturn(new SoftMax(batch.getActivations()));
    }
    ...
    public void pullBack(INDArray errors) {
       ...
       super.errorsForPreviousLayer = Nd4j.getExecutioner().execAndReturn(new SoftMaxDerivative(inputData)).mul(errors);
    }
