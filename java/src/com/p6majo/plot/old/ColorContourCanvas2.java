...
//###################################################################
//
public class ColorContourCanvas2 extends Canvas
{
public ColorContourCanvas2(ColorContourPlot2 parent)
{
    super();
    Parent      = parent;
...
public int  getResolution()
{
    ...
    /**
     * obtain min and max value of the data
     */
...
public void paint(Graphics g)
{
    ...
    int boxWidth  = dim.width/xCanvasPanelCount;
    int boxHeight = dim.height/yCanvasPanelCount;
    if(boxWidth  <= 1)
    {
     xCanvasPanelCount = dim.width/2;
     boxWidth  =  dim.width/xCanvasPanelCount;
    }
    if(boxHeight <= 1)
    {
    yCanvasPanelCount = dim.height/2;
    boxHeight = dim.height/yCanvasPanelCount;
    }
    int xOffset = (dim.width  - xCanvasPanelCount*boxWidth)/2;
    int yOffset = (dim.height - yCanvasPanelCount*boxHeight)/2;
    int xCanvasLocation;
    int yCanvasLocation;
...
//
    ...
    for(i = 0; i < colorCount; i++)
    {
        ...
        //black and white alternation to produce sharp edges (contour lines)

        if (i%2==0) colorArray[i] = Color.BLACK; else colorArray[i] =Color.WHITE;
    }
}
