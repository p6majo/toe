...
/**
 * Extention of the class <i> Draw.java</i>
 * It adds three buttons to the Frame and allows for interaction with the user
 *
 * @author p6majo
 ...
 *
 */
public class ExtendedDraw  implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static enum STROKE_TYPE  {Solid,Dashed,Dotted};
     ...
     */
    public ExtendedDraw(String name) {
        this.name = name;
        init();
            ...
            button1.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    actionPane.setText("Button 1 pressed!\n You might want to override the Listener by a customized Listener via setListenerForButton1.");
            ...
            button2.addActionListener(new ActionListener() {
                ...
                @Override
                public void actionPerformed(ActionEvent e) {
                    actionPane.setText("Button 2 pressed!\n You might want to override the Listener by a customized Listener via setListenerForButton2.");
                    actionPane.setVisible(true);
    ...
    private void init() {
        ...
        actionPane.setVisible(true);//only needed for default actions
        frame.pack();
    ...
    public void setButton1Label(String label){
    ...
    public void setButton3Label(String label){
    ...
    public void setActionListenerForButton2(ActionListener listener){
        button2.removeActionListener(button2.getActionListeners()[0]);
        button2.addActionListener(listener);
    }
    public void setActionListenerForButton3(ActionListener listener){
    ...
    public void setStroke(Draw.STROKE_TYPE stroke){
