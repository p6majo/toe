...
public class Chebyshev {
  ...
  public Chebyshev(final UniVarRealValueFun func, final double aa, final double bb) {
    this(func, aa,bb, 50);
  }
  
  public Chebyshev(final UniVarRealValueFun func, final double aa, final double bb, final int nn){
    n = nn;
    m = nn;
    c = new double[n];
    a = aa;
  ...
  public double[] polycofs() {return polycofs(m);}
